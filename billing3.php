...
echo '
  ...
  <strong>Can not proceed!</strong> you selected an amount lower than ₦50,000
</div>
                    ';
                    ...
                    $ins_sql = "UPDATE provide SET amount='$_POST[amount]' WHERE user_id = '$_SESSION[id]'";
                                     ...
                                     echo "<script type='text/javascript'> document.location = 'billing-process3.php?fundaddress'; </script>";
                }else{
    ...
    ?>
            <div class="row">
                                ...
                                <div class="panel-heading" style="background-color: green;">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#depositPanel"
                                           data-parent="#transactionParentPanel" style="color: white;">BANK TRANSFER</a>
                                    </h4>
                                </div>
                                <div id="depositPanel" class="panel-collapse collapse in">
                                    <form class="form-horizontal prodigal"
                                          action="billing3.php" method="POST"
                                          role="form">
                                ...
                                <div class="panel-heading" style="background-color: green;">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#withdrawPanel"
                                           data-parent="#transactionParentPanel" style="color: white;">WITHDRAW</a>
                                    </h4>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color: green;">
                            <h3 class="panel-title" style="color: white;">DEPOSITS HISTORY</h3>
                        </div>
                        <div class="panel-body panel-table">
                            ...
                            if($rows = mysqli_fetch_assoc($run_sql)){ ?>
                                                <td class="text-left">
                                                    <a href="billing-process3.php"
                                                       class="btn-link btn-warning">
                                                        <span class="text-uppercase"> ₦<?php echo $rows['amount']; ?></span>
                                                    </a>
                                                </td>
                                                <td>
