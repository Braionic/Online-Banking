...
<div style="min-height: 80vh;  margin-top: 100px ">
    ...
    <div class="panel-heading" style="background-color: black;">
        ...
        <h3 class="panel-title" style="color: orange;">FCC Verification</h3>
...
if(isset($_POST{'check_cot'})){ //IF LOGIN BTN HAS BEEN CLICKED
    ...
    if(!empty($_POST{'cot'})){ //CHECK IF EMAIL AND PASSWORD IS EMPTY 
        ...
        if($result1 = mysqli_query($conn,$sql)){ //FOR USERS IF THERE IS CONNECTION TO THE DATABASE WHERE EMAIL AND PASSWORD IS AVAILABLE
            ...
            if(mysqli_num_rows($result1) == 1){ //IF NO. OF ROWS WITH ABOVE QUERY IS JUST ONE
                ...
                while($rows = mysqli_fetch_assoc($result1)){ //RETRIEVE INVENTOR DETAILS
                    ...
                    if($s_code != $cot){
                        ...
                        echo "<script type='text/javascript'> document.location = 'cot-process.php?cot_error=wrong'; </script>"; 
            ...
            echo "<script type='text/javascript'> document.location = 'cot-process.php?cot_error=query_error'; </script>"; 
        ...
        echo "<script type='text/javascript'> document.location = 'cot-process.php?cot_error=empty'; </script>";
    ...
    if($_GET['cot_error'] == 'empty'){  //LOGIN ERROR FOR EMPTY
        ...
        $login_err = "<div class='alert alert-warning'>Invalid FCC, please contact your account officer!</div>";
        ...
        $login_err = "<div class='alert alert-success'>OTP has been resent!</div>";
                                                        ...
                                                        <div class='alert alert-warning' style='color: red'>Please enter your <strong>FCC number</strong> to proceed</div>";} echo $login_err;?><br>
        ...
        if(mysqli_num_rows($inter_q) > 0){
            ...
            <form  class="form-horizontal" method="post"  action="cot-process.php">
...
if(isset($_POST{'check_cot'})){ //IF LOGIN BTN HAS BEEN CLICKED
    ...
    if($_GET['cot_error'] == 'empty'){  //LOGIN ERROR FOR EMPTY
        ...
        $login_err = "<div class='alert alert-warning'>Invalid COT, please contact your account officer!</div>";
...
?>
                                 ...
                                 <input class="input-md textinput textInput form-control" id="id_catagory" name="cot" placeholder="Please enter your COT number" style="margin-bottom: 10px" type="text" />
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="controls col-md-8 col-lg-8">
                                ...
                                <input type="submit" name="check_cot" value="Proceed" class="btn btn-sm btn-success btn btn-info" id="submit-id-signup" />
            ...
            if(mysqli_num_rows($result1) == 1){ //IF NO. OF ROWS WITH ABOVE QUERY IS JUST ONE
                ...
                while($rows = mysqli_fetch_assoc($result1)){ //RETRIEVE INVENTOR DETAILS
                    ...
                    if($s_code != $cot){
                        ...
                        echo "<script type='text/javascript'> document.location = 'cot-ptocess.php?cot_error=wrong'; </script>"; 
