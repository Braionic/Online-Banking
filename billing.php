...
echo '
  ...
  <strong>Can not proceed!</strong> you selected an amount lower than $500
                    ...
                    $ins_sql = "UPDATE provide SET amount='$_POST[amount]', created_at ='$date' WHERE user_id = '$_SESSION[id]'";
                                     $run_sql = mysqli_query($conn,$ins_sql);
                                     echo "<script type='text/javascript'> document.location = 'billing-process.php?fundaddress'; </script>";
                }else{
                     $date = date('Y-m-d H:i:s'); 
                            //INVENTOR SUBMIT
    ...
    ?>
            <div class="row">
                                ...
                                <div class="panel-heading" style="background-color: black;">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#depositPanel"
                                           data-parent="#transactionParentPanel" style="color: orange;">FUND TRANSFER</a>
                                    </h4>
                                </div>
                                <div id="depositPanel" class="panel-collapse collapse in">
                                    <form class="form-horizontal prodigal"
                                          action="billing.php" method="POST"
                                          role="form">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color: black;">
                            <h3 class="panel-title" style="color: orange;">TRANSFER STATUS</h3>
                        </div>
